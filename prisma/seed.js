...
//
//     const admins = [
//         { email: process.env.ADMIN_EMAIL_1, fullName: 'Super Admin 1', password: process.env.ADMIN_PASSWORD_1 },
//         { email: process.env.ADMIN_EMAIL_2, fullName: 'Super Admin 2', password: process.env.ADMIN_PASSWORD_2 },
//         { email: process.env.ADMIN_EMAIL_3, fullName: 'Super Admin 3', password: process.env.ADMIN_PASSWORD_3 },
//     ];
//
//     for (const adminData of admins) {
//         if (!adminData.email || !adminData.password) {
//             console.error('❌ All ADMIN_EMAIL_X and ADMIN_PASSWORD_X must be set in .env');
//             process.exit(1);
//         }
//
//         const hashedPass = await bcrypt.hash(adminData.password, 12);
//         const admin = await prisma.user.upsert({
//             where: { email: adminData.email },
//             update: { password: hashedPass, role: 'ADMIN' },
//             create: {
